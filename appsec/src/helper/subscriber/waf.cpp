...
instance::instance(parameter &rule, 
    metrics::TelemetrySubmitter &msubmit, std::uint64_t waf_timeout_us,
    ...
    : waf_timeout_{waf_timeout_us}, msubmitter_{msubmit}
{
    ...
    msubmit.submit_legacy_meta(metrics::waf_version, ddwaf_get_version());
...
subscriber::ptr instance::update(parameter &rule, metrics::TelemetrySubmitter &msubmitter)
{
    ddwaf_object diagnostics;
